...
const cardsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    builder.addCase(CardsThunks.paginationPage.pending, (state) => {
      state.loading = true
      state.error = null
    })
    builder.addCase(CardsThunks.paginationPage.fulfilled, (state, action) => {
      state.allCards = action.payload
      state.error = null
      state.loading = false
    })
    builder.addCase(CardsThunks.paginationPage.rejected, (state, action) => {
      state.loading = false
      if (action.payload) {
        state.error = action.payload.errorMessage
      } else {
